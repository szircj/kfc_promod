main()
{
	...
	// website
	setDvar( "promod_hud_website", "^1[^7KFC^1]^4Pro^1mod^7[PA]" ); // (avoid "//" here)
	...
	setDvar( "promod_mc_message_1", "Enviar Reporte Jugadores sospechoso comando: ^1!rep ^1[^7nombre^1] [^7porque^1]" );
	setDvar( "promod_mc_message_2", "Send Report Suspected Players Command: ^1!rep ^1[^7name^1] [^7because^1]" );
	setDvar( "promod_mc_message_3", "Discord ^1[^7KFC^1] ^7discord.gg/xh63eygS78" );
